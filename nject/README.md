...
```
## Why `nject`?
- **zero cost**: Using this library is equivalent to manually injecting your dependencies as show in the [benchmarks](https://github.com/nicolascotton/nject/tree/main/examples/benchmark).
